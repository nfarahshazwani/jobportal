...
<head>
  ...
  <title>THE GIG RIG Job Portal</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index.php" class="logo logo-bg">
      ...
      <span class="logo-lg"><b>THE GIG RIG Job</b> Portal</span>
    </a>
          ...
          */
          ...
          if($result->num_rows > 0) {
            ...
            <div class="attachment-block clearfix">
                <img class="attachment-img" src="img/applynow.jpg" alt="Attachment Image">
              <div class="attachment-pushed">
                <h4 class="attachment-heading"><a href="view-job-post.php?id=<?php echo $row['id_jobpost']; ?>"><?php echo $row['jobtitle']; ?></a> <span class="attachment-heading pull-right">RM<?php echo $row['maximumsalary']; ?>/Month</span></h4>
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-md-6 about-text margin-bottom-20">
              <h1 style="color: blue;"><strong>THE GIG RIG</strong></h1>
              <h2 style="color: blue;">Have Collaborate With</h2>
              <h2 style="color: blue;"><strong>'1 Thousand Company' </strong></h2>
            <p>The GIG RIG online job portal application allows job seekers and recruiters to connect.The application provides the ability for job seekers to create their accounts, upload their profile and resume, search for jobs, apply for jobs, view different job openings. The application provides the ability for companies to create their accounts, search candidates, create job postings, and view candidates applications.
            </p>
            <p>
              THE GIG RIG helps the applicant to find their suitable Jobs by using data analysis acquired from them with the job suitability.

              THE GIG RIG also collaborate with a good companies for their employees to find the job with the job qualification and their suitability. 
              This Platform also provide direct communication, location of the company and also the Salary of their dream job.
              Here also give helps for facilitate the matching and communication of job opportunities between job seekers and employers.
              
              This site can be used as a paving path for both companies and job-seekers for a better life .
            <p><Strong>**Any problems can Contact ADMIN by email farahfeb95@gmail.com or 0122986076**</strong></p>
            </p>
          </div>
        </div>
      </div>
  ...
  <footer class="main-footer" style="margin-left: 0px;">
    <div class="text-center">
      <strong>Copyright &copy; 2016-2017 <a href="learningfromscratch.online">THE GIG RIG Job Portal</a>.</strong> All rights
    reserved.
    </div>
  </footer>
