                ...
                <ul class="nav nav-pills nav-stacked tree" data-widget="tree">
                  <li class="treeview menu-open">
                    ...
                    <ul class="treeview-menu">
                      <li><a href=""  class="citySearch" data-target="Kuala Lumpur"><i class="fa fa-circle-o text-yellow"></i> Kuala Lumpur</a></li>
                      <li><a href="" class="citySearch" data-target="Selangor"><i class="fa fa-circle-o text-yellow"></i> Selangor</a></li>
                      <li><a href="" class="citySearch" data-target="Perak"><i class="fa fa-circle-o text-yellow"></i> Perak</a></li>
                    </ul>
                  </li>
                  <li class="treeview menu-open">
